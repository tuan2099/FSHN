...
<header id="masthead" class="site-header fixed top-0 left-0 w-full z-50 transition-all duration-500 py-6 lg:py-8">
	<div class="container mx-auto px-6 flex justify-between items-center">
		...
		<div class="header-left flex-1">
			<button class="menu-toggle text-white hover:text-brand-orange transition-colors focus:outline-none group">
		...
		<div class="header-right flex-1 flex justify-end">
			<a href="#" class="bg-brand-orange text-white px-8 py-2 md:px-10 md:py-3 text-[10px] md:text-xs font-bold uppercase tracking-widest hover:bg-white hover:text-brand-blue transition-all shadow-xl">
				BOOK A STAY
			</a>
		</div>
	</div>
...
<div id="side-menu" class="fixed inset-0 z-[100] invisible pointer-events-none transition-all duration-500">
    <!-- Backdrop -->
    <div class="absolute inset-0 bg-brand-black-900/50 opacity-0 transition-opacity duration-500 menu-backdrop"></div>
    
    <!-- Menu Content -->
    <div class="absolute top-0 left-0 h-full w-full md:w-1/3 bg-white translate-x-[-100%] transition-transform duration-500 shadow-2xl p-12 lg:p-20 flex flex-col menu-content">
        <!-- Close Button -->
        ...
        <div class="pt-12 border-t border-brand-black-100">
            <h4 class="text-xs font-bold text-brand-blue uppercase tracking-widest mb-4 italic font-serif">LÈGACY - A FUSION ORIGINAL HA NOI</h4>
            <p class="text-[10px] text-brand-black-400 font-medium tracking-widest">345 Doi Can, Ngoc Ha Ward, Hanoi City</p>
        </div>
    </div>
</div>
