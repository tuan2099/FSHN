        ...
        'fields' => array(
            ...
            array(
                ...
                'sub_fields' => array(
                    ...
                    array(
                        'key' => 'field_fohn_spa_block_btn_text',
                        'label' => 'Button Text',
                        'name' => 'button_text',
                        'type' => 'text',
                        'default_value' => 'Learn More',
                        'instructions' => 'Label for the button. Only shown when Button Link is filled.',
                    ),
                    array(
                        'key' => 'field_fohn_spa_block_btn_link',
                        'label' => 'Button Link',
                        'name' => 'button_link',
                        'type' => 'url',
                        'instructions' => 'Leave empty to hide the button for this block.',
                    ),
                ),
            ),
        ),
