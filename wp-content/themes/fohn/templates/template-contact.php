                ...
                <div class="w-full py-16 lg:py-24" data-aos="fade-left" data-aos-delay="200">
                    <div class="w-full lg:max-w-[420px] ml-auto">
                        ...
                        <div class="contact-form-wrapper">
                            ...
                            <?php else: ?>
                                <!-- Fallback Mockup Form -->
                                <div class="space-y-5">
                                    <div class="relative">
                                        <label
                                            class="absolute left-6 top-5 text-[11px] font-bold text-brand-black-600 uppercase tracking-wider"><?php pll_e('Name:'); ?></label>
                                        <input type="text"
                                            class="custom-input w-full pt-10 pb-3 px-6 border-2 border-slate-200 rounded-[20px] focus:border-brand-orange transition-all outline-none">
                                    </div>
                                    <div class="relative">
                                        <label
                                            class="absolute left-6 top-5 text-[11px] font-bold text-brand-black-600 uppercase tracking-wider"><?php pll_e('Email:'); ?></label>
                                        <input type="email"
                                            class="custom-input w-full pt-10 pb-3 px-6 border-2 border-slate-200 rounded-[20px] focus:border-brand-orange transition-all outline-none">
                                    </div>
                                    <div class="relative">
                                        <label
                                            class="absolute left-6 top-5 text-[11px] font-bold text-brand-black-600 uppercase tracking-wider"><?php pll_e('Phone:'); ?></label>
                                        <div
                                            class="flex items-center pt-10 pb-3 px-6 border-2 border-slate-200 rounded-[20px] bg-white">
                                    ...
                                    <div class="relative">
                                        <label
                                            class="absolute left-6 top-5 text-[11px] font-bold text-brand-black-600 uppercase tracking-wider"><?php pll_e('Write your requries:'); ?></label>
                                        <textarea rows="3"
                                            class="custom-input w-full pt-10 pb-3 px-6 border-2 border-slate-200 rounded-[20px] focus:border-brand-orange transition-all outline-none resize-none"></textarea>
                                    </div>

                                    <div class="text-center pt-6">
                                        <button
                                            class="bg-brand-orange text-white px-16 py-3 rounded-md font-bold uppercase tracking-widest hover:bg-brand-blue transition-all shadow-lg text-sm">
                                            <?php pll_e('SEND'); ?>
                                        </button>
                                    </div>
                                </div>
